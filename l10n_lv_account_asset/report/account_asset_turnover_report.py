...
class account_asset_turnover(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(account_asset_turnover, self).__init__(
    ...
    def lines(self, form, ids=[]):
        ...
        purchase1 = depr1 = left1 = 0.0
        purchase2 = depr2 = left2 = 0.0
        purchase3 = depr3 = left3 = 0.0
        purchase4 = depr4 = left4 = 0.0

        purchase_total1 = depr_total1 = left_total1 = 0.0
        purchase_total2 = depr_total2 = left_total2 = 0.0
        ...
        for asset in assets:
            ...
            for line in asset.depreciation_line_ids:
                if ((line.move_check == True or line.init_entry == True)
                    and line.depreciation_date < form['from_date']):
                    depr_1 += line.amount
            depr1 = depr_1
            ...
            for line in asset.depreciation_line_ids:
                if ((line.move_check == True or line.init_entry == True)
                    and line.depreciation_date >= form['from_date']
                    and line.depreciation_date <= form['to_date']):
                    depr_3 += line.amount
            depr3 = depr_3
